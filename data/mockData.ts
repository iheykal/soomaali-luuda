...
export const mockUsers = [
  ...
  { id: 'u005', name: 'Somali AI', email: 'ai@gemini.dev', balance: null, gamesPlayed: 100, wins: 78, status: 'System', joined: '2023-01-01', avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=Somali' },
];
...
export const mockGames = [
  ...
  {
    id: 'g002',
    players: ['Charlie (u003)', 'Somali AI'],
    stake: 100,
    pot: 200,
    winner: 'Charlie (u003)',
    status: 'Completed',
